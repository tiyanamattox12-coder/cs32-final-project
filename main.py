...
noun = ['What is the name of your first pet? ', 'What was your favorite childhood toy?', 'Name a place you've always wanted to vist.', What's an object you use everyday?', 'Name a funny looking animal,', What's a type of food you love?', What is your dream job?', Name your favorite Harry Potter character.', 'What's a holiday you enjoy?', 'Name something you would see in the sky.' ]
verb = ['Favorite way to get to classes.', 'Something you do when you're bored.', 'Favorite mode of travel.','Something you do before a party.','An action you'd do on a summer day.', 'A verb related to studying.','Something that makes you laugh.','A verb related to the kitchen.']
